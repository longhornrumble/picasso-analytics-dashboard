...
interface SessionTimelineProps {
  ...
  /** Callback when "View Form" is clicked for sessions with form submission */
...
export function SessionTimeline({ sessionId, onClose, mockSessionDetail, onViewFormSubmission }: SessionTimelineProps) {
      ...
      >
        ...
        <div className="px-6 py-3 border-t border-gray-200 bg-gray-50">
          <div className="flex justify-between items-center">
            {/* View Form button - show when form was completed */}
            {session && onViewFormSubmission && (session.summary.outcome === 'form_completed' || session.summary.form_id) ? (
              <button
                onClick={() => {
                  onViewFormSubmission(session.session_id, session.summary.form_id || '');
                  onClose();
                }}
