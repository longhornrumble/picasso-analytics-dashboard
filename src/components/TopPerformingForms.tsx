  ...
  return (
    <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
      ...
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-lg font-semibold text-gray-900">Top Performing Forms</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        >
          ...
          <span className="text-sm font-medium text-gray-700">View All Forms</span>
          <span className="text-xs text-green-500">{totalActiveForms} active forms</span>
        </button>
      </div>
    </div>
  );
